...
# Source0-md5:	44fdfc59f49d89b99f01db96adc41f34
...
BuildRequires:	libhinawa-devel >= 2.6.0
...
Requires:	libhinawa-devel >= 2.6.0
...
%{__mv} $RPM_BUILD_ROOT%{_docdir}/hinoko $RPM_BUILD_ROOT%{_gtkdocdir}
%endif
...
%attr(755,root,root) %ghost %{_libdir}/libhinoko.so.0
%{_libdir}/girepository-1.0/Hinoko-0.0.typelib

%files devel
%defattr(644,root,root,755)
%attr(755,root,root) %{_libdir}/libhinoko.so
%{_includedir}/hinoko
%{_datadir}/gir-1.0/Hinoko-0.0.gir
